...
const MainSplash = () => {
  return (
    <div className='flex flex-col items-center bg-zinc-900 h-screen w-full'>
      ...
      <div className='absolute top-[calc(30%)] flex flex-col justify-center items-center border-solid border-2 border-gold rounded bg-pale-gold p-5 lg:p-10'>
        <div className='uppercase tracking-widest text-3xl lg:text-6xl text-center text-blood-red'>
          <p>joanne</p>
        ...
        <div className='flex flex-col justify-center items-center mt-6 lg:mt-12'>
          <Link to='/rsvp'>
            <div className='border-solid border-2 border-gold p-3 uppercase lg:text-2xl text-gold tracking-widest'>rsvp by august 1, 2025</div>
          </Link>
        </div>
      </div>
      <div className='absolute top-[calc(80%)] lg:w-3/5 w-5/6 border-t-2 border-gold text-white'>
        <div className='flex flex-row justify-around uppercase text-center text-xs lg:text-base'>
