  ...
  return (
    <div className='flex flex-col justify-center items-center bg-zinc-900 mt-14'>
      <div className='mt-12 lg:w-1/2 w-5/6 bg-white border-x-2 border-t-2 border-gold rounded-t-sm'>
        <p className='uppercase tracking-wide lg:text-6xl text-4xl text-center text-blood-red pt-4 bg-pale-gold'>schedule</p>
        <p className='tracking-wide lg:text-xl text-xl text-center bg-pale-gold pt-2 lg:pt-10'>SmogShoppe by Marvimon</p>
      ...
      <div className='flex justify-center'>
        <div className='grid grid-cols-2 justify-items-stretch pt-10 lg:w-1/2 w-5/6 border-x-2 border-gold pb-2 bg-pale-gold'>
          {/* ROW 1 */}
          <div className='border-solid border-r-2 border-blood-red'></div>
          <div className='border-solid border-l-2 border-blood-red p-4'>
            <div className='uppercase tracking-wide lg:text-5xl text-lg text-gold'>welcome drinks</div>
            <p className='mt-2'>5:00 - 6:00</p>
            <div className='font-light lg:text-xl lg:w-3/4 lg:mt-4 tracking-wide'>Let's all have a drink and celebrate together! Enjoy the open bar with His & Her's custom cocktails, beer & wine,
          ...
          <div className='border-solid border-r-2 border-blood-red p-4 text-right'>
            <div className='uppercase tracking-wide lg:text-5xl text-lg text-gold'>love story recap</div>
            <p>6:00 - 6:20</p>
            <p className='font-light lg:text-xl lg:ml-32 lg:mt-4 tracking-wide'>Time for some embarrassing stories of how Joanne & Eliot met!
            </p>
          </div>          
          ...
          <div className='border-solid border-r-2 border-blood-red'></div>
          <div className='border-solid border-l-2 border-blood-red p-4'>
            <div className='uppercase tracking-wide lg:text-5xl text-lg text-gold'>dinner</div>
            <p>6:30 - 7:30</p>
            <div className='font-light lg:text-xl lg:w-3/4 lg:mt-4 tracking-wide'>Buffet service by Fundamental Catering. Wedding cake by... Eliot?!
            </div>
          </div>

          {/* ROW 4 */}
          <div className='border-solid border-r-2 border-blood-red p-4 text-right'>
            <div className='uppercase tracking-wide lg:text-5xl text-lg text-gold'>celebration</div>
            <p>7:30 - 10:00</p>
            <div className='font-light lg:text-xl lg:ml-32 lg:mt-4 tracking-wide'>Open bar. Bangers by DJ XXX. Dance floor.
            </div>
          </div>
          <div className='border-solid border-l-2 border-blood-red'></div>
      ...
      <div className='lg:w-1/2 w-5/6 bg-pale-gold border-x-2 border-b-2 mb-36 pb-10 border-gold'>
        <div className='flex flex-col lg:mx-32'>
          ...
          <p className='text-center font-light px-4 lg:px-0 lg:text-xl'>Lyft is your friend!
          ...
          <p className='text-center font-light px-4 lg:px-0 lg:text-xl'><span className='font-normal'>Formal</span>
